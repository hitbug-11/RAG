...
from src.attack_for_watermark import Attacker
...
def parse_args():
    ...
    parser.add_argument('--water', type=int, default=0)
    # attack
...
def main():
    ...
    for iter in range(args.repeat_times):
        ...
        for i in target_queries_idx:
            ...
            cor_ans = incorrect_answers[i]['correct answer'] 
            ...
            if True: # topk
                ...
                if args.attack_method not in [None, 'None']: 
                    ...
                    for j in range(len(adv_text_list)):
                        ...
                        #topk_results.append({'score': adv_sim, 'context': adv_text_list[j], 'embed':adv_emb})
