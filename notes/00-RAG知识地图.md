...
- [RAG© 论文路线复现：Contriever 检索门控与 Qwen3-8B 替代实验](./05-ragc-qwen-reproduction.md)
...
4. 阅读 [RAG© 论文笔记](./02-ragc-paper.md)，将透明 RAG 的观测点映射到版权验证方法；
5. 最后阅读 [RAG© 论文路线复现](./05-ragc-qwen-reproduction.md)，理解论文设置、Qwen 替代结果以及 Retriever—Generator—Detector 的分层误差。
